    ...
    <div class="wrapper">
        <div class="container" v-if="flag">
            <div class="name">
                ...
                <input type="text" placeholder="请输入姓名" ref="name-input" v-model="data.detail.name">
            </div>
            <div class="phone">
                <span class="label">电&nbsp;&nbsp;&nbsp;话：</span>
                <input type="text" placeholder="请输入电话" ref="phone-input" v-model="data.detail.mobile">
            </div>
            <div class="address">
        ...
        <v-maskerfail v-show="isToastFail" :text="text"></v-maskerfail>
...
export default {
    ...
    methods: {
        getData() {
            this.$http.get(url.getDelivery, {
                params: {
                    id: util.parseUrl(window.location.href).id
                }
            }).then((response) => {
        ...
        submit () {
            ...
            this.$http.get(url.updateDelivery, {
                params: {
                    name: name,
                    mobile: phone,
